  ...
  useEffect(() => {
    const fetchFruits = async () => {
      try {
        ...
        const fruitItems = items.documents.filter(item => 
          item.kategorie === "Fruits" || (item.kategorie as any) === "Obst"
        );
          ...
          <View style={styles.itemsList}>
            {filteredItems.map((item) => (
              <View key={item.$id} style={styles.listItemCard}>
                <Image source={require("../../../assets/images/fridge_icons/fruits.png")} style={styles.listItemImage} />
