...
const categories = [
  ...
  { id: 4, name: "Bread",     img: require("../../../assets/images/fridge_icons/bread.png"), route: "/(tabs)/fridge/fridge_bread" },
  { id: 5, name: "Drinks",    img: require("../../../assets/images/fridge_icons/drinks.png"), route: "/(tabs)/fridge/fridge_drinks" },
  { id: 6, name: "Meat",      img: require("../../../assets/images/fridge_icons/meat-fish.png"), route: "/(tabs)/fridge/fridge_meat" },
];
