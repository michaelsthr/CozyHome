...
export default function Fridge() {
    ...
    const getCategoryDisplayInfo = (categoryValue: string | undefined) => {
        ...
        const isValidCategory = Object.values(FridgeCategories).includes(
            categoryValue as FridgeCategoryType
        );
    ...
    const handleEditItem = (item: KuehlschrankItem) => {
        ...
        const isValidCategory = Object.values(FridgeCategories).includes(
            itemCategory as FridgeCategoryType
        );
    ...
    const getFilteredItems = () => {
        ...
        return filteredItems.sort((a, b) => {
            if (sortBy === "name") {
                ...
                return sortDirection === "asc" ? a.anzahl - b.anzahl : b.anzahl - a.anzahl;
    ...
    return (
        <View style={styles.container}>
            <Text style={fontStyles.title}>Virtueller Kühlschrank</Text>
            ...
            <View style={styles.filterSection}>
                ...
                <ScrollView
                    ...
                    {categories.map((categoryValue) => {
                        ...
                        const itemCount =
                            contents?.documents?.filter((item) => item.kategorie === categoryValue)
                                .length || 0;
